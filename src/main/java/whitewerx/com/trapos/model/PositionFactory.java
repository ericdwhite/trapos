...
/**
 * Creates positions so that they
...
public class PositionFactory {
    ...
    /**
     * TODO: note this assumes the PNL currency is always the quote currency
     *       in a real system this would not be correct.
     *       
     *       For example if the PNL currency is USD, and the position
     *       is USDCAD then this would be incorrect.
     *       
     * @param currencyPair for the flat position.
     * @return
     */
